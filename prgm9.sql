...
4 rows selected.
or
a))SELECT S1.sid FROM Sailor S1, Reserve R1, Boat B1 WHERE S1.sid=R1.sid AND R1.bid=B1.bid AND B1.color='red' UNION SELECT S2.sid FROM Sailor S2, Reserve R2, Boat B2 WHERE S2.sid=R2.sid AND R2.bid=B2.bid AND B2.color='green';
